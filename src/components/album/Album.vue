  ...
  <div class="album">
    <div class="detail">
      ...
      <div class="info">
        ...
        <div class="choices">
          <el-button type="danger" class="el-icon-video-play" size="mini" round
            >播放全部</el-button
          >
          <el-button
            @click="subAlbum"
            ...
            >收藏</el-button
          >
          <el-button size="mini" class="el-icon-download" round
            >下载全部</el-button
          >
          <el-button size="mini" class="el-icon-position" round>{{
            shareCount
          }}</el-button>
        </div>
        <p>歌手: {{ artistName }}</p>
...
<script>
import { getAlbumData, subAlbum } from "../../network/getAlbumData";
...
export default {
  ...
  methods: {
    getAlbumData() {
      getAlbumData(this.$route.params.id)
        .then((res) => {
          console.log(res);
